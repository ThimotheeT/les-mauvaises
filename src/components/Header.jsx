...
const Header = () => (
  <header className="flex flex-col items-center mt-2 sm:mt-3 md:mt-4 lg:mt-5">
    <img 
      src="/smiley-removebg-preview.png" 
      alt="Smiley" 
    ...
    <div className="relative w-full flex justify-center mb-2 sm:mb-3 md:mb-4 lg:mb-5">
      <h1 className="font-soulmaze text-[9vw] md:text-[7vw] lg:text-[6vw] mt-2 sm:mt-3 md:mt-4 lg:mt-5 flex flex-col items-center relative text-center">
        <span className="relative">
          PRÊTS POUR
          <img src="/Vector 111.svg" alt="" className="absolute top-[3.5vw] left-[6vw] w-[7vw] md:top-[2.5vw] md:left-[5vw] md:w-[6vw] lg:top-[2vw] lg:left-[4vw] lg:w-[5vw] h-auto z-10" />
          <img src="/Vector 112.svg" alt="" className="absolute top-[3.5vw] right-[21.5vw] w-[7vw] md:top-[2.5vw] md:right-[16.5vw] md:w-[6vw] lg:top-[2vw] lg:right-[14vw] lg:w-[5vw] h-auto z-10" />
        </span>
        <span className="relative -mt-2 sm:-mt-3 md:-mt-4 lg:-mt-8">
          UN PLAN À 3
          <img src="/Vector 114.svg" alt="" className="absolute top-[3.5vw] left-[30vw] w-[7vw] md:top-[2.5vw] md:left-[23vw] md:w-[6vw] lg:top-[2vw] lg:left-[20vw] lg:w-[5vw] h-auto z-10" />
          <img src="/Vector 113.svg" alt="" className="absolute top-[3vw] right-[0vw] w-[5vw] md:top-[2vw] md:w-[4.5vw] lg:w-[3.5vw] h-auto z-10" />
        </span>
      </h1>
      <img 
        src="/ponctuation-removebg-preview.png" 
        alt="Ponctu" 
